...
fruits.push("orange");
console.log("[Questions#10] ".fruits);
...
console.log("[Question #48]: ", strinVar.endsWith("0")); // should print true
...
console.log("[Question #77]:", typeof isVisible === "bolean"); // should print true

// 78. Add 25 to 'circleArea' using the += assignment operator.
circleArea += 25;
console.log("[Question #77]:", typeof isVisible === "boolean"); //shoul print true
// 79. Find out if 'book' has a property named 'genre'.
const hasGnreProperty = "genre" in book;
...
console.log("[Question #80]", days.lenght === 2);
...
const containSubstringAr = city.includes("ar");
console.log("[Question #85]:", containSubstringAr);
...
console.log("[Questions # 86]:", cubeVolume);
...
console.timeLog("Question #88]:", days.length > 0);
...
const weightStr = wieght.toString();
...
const haslsbnProperty = "isbn" in book;
console.log("[Question #98]; ", haslsbnProperty);
